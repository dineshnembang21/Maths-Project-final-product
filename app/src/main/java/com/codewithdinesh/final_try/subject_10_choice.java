...
public class subject_10_choice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subject_10_choice);
        //
        //for tool bar
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.menu_home:
                        Intent inn=new Intent(subject_10_choice.this,Nex.class);
                        startActivity(inn);
                    ...
                    case R.id.menu_about:
                        ...
                        Intent intent = new Intent(subject_10_choice.this, about_us.class);
        ...
        btn_index.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(subject_10_choice.this, index_topic.class);
                startActivity(in);
            }
        });
        ...
        btn_com.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(subject_10_choice.this, compulsory_maths.class);
                startActivity(in);
            }
        });
        ...
        btn_prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(subject_10_choice.this,Nex.class);
                startActivity(in);
            }
        });
